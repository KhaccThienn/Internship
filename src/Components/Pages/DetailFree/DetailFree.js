          ...
          <div className="container-fluid ">
            ...
            <div className={cx("container-fruid", "rikacmt")}>
              <div className="row">
                ...
                <div className={cx("col-lg-6", "p-0", "cmt")}>
                  <a className="">Khóa Học rất hay, rất chất lượng, tôi đã có công việc lương tháng 100$</a>
                </div>
              </div>
            </div>
            ...
            <div className={cx("container-fruid", "rikacmt")}>
              <div className="row">
                ...
                <div className={cx("col-lg-6", "p-0", "cmt")}>
                  <a className="">Ngành IT Việt Nam hiện nay ở đầu của sự phát triển. Có thể nói IT là vua của các nghề. Vừa có tiền, có quyền. Vừa kiếm được nhiều $ lại được xã hội trọng vọng.
                    ...
                    Gái gú thì cứ nghe nó bảo làm CNTT thì chảy nước. Có bé kia dân du học sinh Úc, về được cô chị giới thiệu làm ngân hàng VCB. Thế nào thằng ấy đi mở thẻ tín dụng gặp phải thế là hốt được cả chị lẫn em. 3 đứa nó sống chung một căn hộ cao cấp. Nhà con bé kia biết chuyện ban đầu phản đối sau biết thằng đấy học IT thì đổi thái độ, cách ba bữa hỏi thăm, năm bữa tặng quà lấy long, luôn giục cưới kẻo lỡ kèo ngon.</a>
                </div>
              </div>
            </div>
