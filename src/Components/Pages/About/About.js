  ...
  return (
    <div className='container'>
      <div className={cx('about-top')}>
        ...
        <p className={cx('text-center', 'about-text')}>Sứ mệnh của chúng tôi là đem đến cho các bạn những khóa học mới nhất, chất lượng nhất, và phù hợp với mọi người.</p>
        <p className={cx('text-center', 'about-text')}>Chúng tôi đang nỗ lực đổi mới bản thân từng ngày, để F9 trở thành một nơi mà các bạn có thể tin tưởng, theo dõi.</p>
        <p className={cx('text-center', 'about-text')}>Khởi đầu là một nhóm nhỏ tại Bachkhoa-Aptech, chúng tôi có những ước mơ lớn. Niềm đam mê của chúng tôi đối với CNTT,  chúng tôi cung cấp cho khách hàng không gì khác ngoài chất lượng sản phẩm cao nhất, đảm bảo đáp ứng nhu cầu của họ và khiến họ hài lòng!</p>
      </div>
      ...
      <div className='about-teacher mt-5'>
        ...
        <div className='row mt-4'>
          <div className='col-lg-4 col-md-4 col-sm-12 rounded'>
            ...
            <p className={cx('text-center', 'font-about', 'mt-2')}>Giảng viên Phạm Xuân Hiền</p>
          </div>
          <div className='col-lg-4 col-md-4 col-sm-12 rounded'>
            <img src={gv_nguyen_van_luan} alt='...' className='card-img' />
            <p className={cx('text-center', 'font-about', 'mt-2')}>Giảng viên Nguyễn Văn Luận</p>
          </div>
          <div className='col-lg-4 col-md-4 col-sm-12 rounded'>
            <img src={gv_nguyen_anh_luong} alt='...' className='card-img' />
            <p className={cx('text-center', 'font-about', 'mt-2')}>Giảng viên Nguyễn Anh Lương</p>
          </div>
        </div>
      </div>
